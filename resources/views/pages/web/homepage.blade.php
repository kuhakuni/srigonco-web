        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content bg-bg">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Hot News</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body p-0">
                    {{-- CAROUSEL --}}
                    <section class="hot-news p-0">
                        {{-- <div class="container"> --}}
                        <div id="carouselnews" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="{{ asset('/img/img-modal-1.jpeg') }}" class="d-block  w-100"
                                        alt="Missing news Pic" />
                                </div>
                                <div class="carousel-item">
                                    <img src="{{ asset('/img/img-modal-2.jpeg') }}" class="d-block w-100"
                                        alt="Missing news Pic" />
                                </div>
                                <div class="carousel-item">
                                    <img src="{{ asset('/img/img-modal-3.jpeg') }}" class="d-block w-100"
                                        alt="Missing news Pic" />
                                </div>
                                <div class="carousel-item">
                                    <img src="{{ asset('/img/img-modal-4.jpeg') }}" class="d-block w-100"
                                        alt="Missing news Pic" />
                                </div>
                            </div>
        ...
        <div class="pt-0" style="overflow: hidden">
            <div class="container">
                ...
                <div class="col-12 mt-5 d-flex justify-content-center align-items-center">
                    <a href="{{ url('/pariwisata') }}" class="btn mx-auto">Selengkapnya</a>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="carousel-item @if($i === 1)active @endif">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <img src="{{ Storage::url('public/img-umkm/' . $u->image) }}"
                                    class="d-block w-100 img-carousel" alt="Missing UMKM Pic" />
                            </div>
