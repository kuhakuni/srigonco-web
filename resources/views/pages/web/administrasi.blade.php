...
<main>
    <section>
        <div class="container">
            ...
            <div class="card p-4 d-flex flex-lg-row flex-column row border-r-15 my-2">
                ...
                <div class="col-lg-4 col-12 d-flex flex-column align-items-end">
                    ...
                    <a class="fw-bold rounded-3 bg-primary ps-2 text-decoration-none" href="" target="_blank">Unduh <img
